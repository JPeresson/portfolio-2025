...
export default class Resources extends EventEmitter {
	constructor(assets) { // reception des assets
		super();
    ...
    startLoading() {
        for (const asset of this.assets) {//prendre tous les assets
            if (asset.type === "glbModel") {
                this.loaders.gltfLoader.load(asset.path, (file) => { //this asset est trop faible, il n'est que l'enveloppe non téléchargé
